...
short_description: This is my mytask_facts facts module

version_added: "1.0.0"

description: This is my longer description explaining my mytask_facts facts module.
...
- name: Return ansible_facts
  my_namespace.my_collection.mytask_facts:
'''
